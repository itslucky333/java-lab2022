public class Motorbike {
    ...
    public void accelerate() {// add 1 km/hr
    speed = speed + 1;
    }
    public void stop() {// set current speed to zero
    speed = 0;
    }
    ...
    Motorbike pulsar = new Motorbike("Pulsar");// print current speed of Honda  
    honda.printSpeed();
    ...
    honda.printSpeed();// print current speed of Pulsar
    pulsar.printSpeed();
    // now park the Honda car
    honda.stop();// print current speed of Honda 
    honda.printSpeed();
    }
}